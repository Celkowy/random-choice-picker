...
function Input (){
  ...
  return <>
    ...
    <CopyInfo/>
    <div className="choiceWrapper">{choiceTable.map((choice, index) => choice ? <Choice key={index} i={index} click={refPopup} value={choice} choiceTable={choiceTable}/> : null)}</div>
    <div className='popupWrapper'>
      <span className='popup' ref={popup}>Choice copied to clipboard!</span>
    </div>
  </>
}
